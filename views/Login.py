...
class App:
    ...
    def __init__(self):
        ...
        logo = utl.leer_imagen("./assets/LOGIN_RODRIGO.png",(500,500))
        ...
        inicio = tk.Button(frame_form_fill, text = "Iniciar sesion", font=("Times", 15, BOLD), bg= "#3a7ff6", fg= "#fff", command=self.verificar)
